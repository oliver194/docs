...
This will install PHP 8.2 and the required extensions, aswell as nginx and mysql server.

``` bash
apt -y install php8.2 php8.2-{gd,mysql,mbstring,bcmath,xml,curl,zip,intl,sqlite3,fpm} nginx mysql-server tar unzip git
```
